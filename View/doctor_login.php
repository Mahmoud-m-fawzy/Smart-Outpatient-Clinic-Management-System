...
<header class="main-header">
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <h2>Doctor Login</h2>
                <p>Access your medical portal account</p>
            </div>
            ...
            <form action="process-login-doctor.php" method="post" class="login-form">
                ...
                <div class="form-group">
                    <div class="input-with-icon">
                        ...
                        <input type="text" 
                               ...
                               required 
                               value="<?php echo htmlspecialchars($data['id_number'] ?? ($_POST['id_number'] ?? '')); ?>">
                    </div>
                    <?php if (isset($errors['id_number'])): ?>
                        <span class="error-message"><?php echo htmlspecialchars($errors['id_number']); ?></span>
                    <?php endif; ?>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var card = document.querySelector('.creative-login-card');
