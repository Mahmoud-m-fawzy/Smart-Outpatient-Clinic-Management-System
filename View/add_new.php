...
<head>
    ...
    <title>Add New Staff - Medical Center</title>
...
<body>
    <div class="container">
        <div class="header-section">
            ...
            <a href="Mangment_panel_staff.php" class="manage-staff-btn">
        ...
        <div class="form-toggle">
            <button type="button" class="toggle-btn active" id="doctorToggle" onclick="toggleForm('doctor')">
                <i class="fas fa-user-md"></i>
                Add Doctor/TA
            </button>
            <button type="button" class="toggle-btn" id="receptionToggle" onclick="toggleForm('reception')">
