...
// error_log("Patient ID: " . $patient['id']);

// Get first 2 appointments from the database
$upcomingAppointments = $patientModel->getAppointments($patient['id'], null, 2);
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="stats-container">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3><?php echo $upcomingAppointmentsCount; ?></h3>
            ...
            <div class="appointment-card">
                <div class="appointment-header d-flex justify-content-between align-items-center mb-3">
                    <h4 class="mb-0">Upcoming Appointments</h4>
                    <a href="patient_appointments.php" class="btn btn-primary btn-sm">View All</a>
                </div>
                <?php if (empty($upcomingAppointments)): ?>
                    <div class="alert alert-info mb-0">
                        You don't have any upcoming appointments. <a href="book_appointment.php">Book one now</a>.
                    </div>
                <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-1">
                                            ...
                                            <?php if (strtolower($appointment['status']) === 'upcoming' || strtolower($appointment['status']) === 'scheduled'): ?>
    ...
    <div class="ai-chatbot-container">
        <div class="ai-chatbot-icon" id="openChatbot">
    ...
    <style>
        ...
        .ai-chatbot-icon::before {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(45deg, rgba(37, 99, 235, 0.4), rgba(16, 185, 129, 0.2));
            opacity: 0;
            transition: opacity 0.3s ease;
            z-index: -1;
        }
        
        .ai-chatbot-icon:hover::before {
            opacity: 1;
        }
